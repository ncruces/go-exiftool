...
%Image::ExifTool::DJI::Main = (
    ...
    0x04 => { Name => 'SpeedY',      Writable => 'float', %convFloat2 },
    0x05 => { Name => 'SpeedZ',      Writable => 'float', %convFloat2 },
...
'Thermal parameters extracted from APP4 of DJI RJPEG files from the ZH20T.',
    ...
    0x4c => { Name => 'AmbientTemperature', Format => 'int16u' },
...
%Image::ExifTool::DJI::Protobuf = (
    ...
    'dvtm_AVATA2_2-2-3-1' => 'SerialNumber2',
    'dvtm_AVATA2_2-3'     => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    ...
    'dvtm_dji_neo_2-2-3-1' => 'SerialNumber2',
    'dvtm_dji_neo_2-3'     => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    ...
    'dvtm_Mini5Pro_1-1-5'  => { Name => 'SerialNumber', Notes => 'Mini 5 Pro' },
    'dvtm_Mini5Pro_1-1-10' => 'Model',
    'dvtm_Mini5Pro_3-2-37-1' => { Name => 'Temperature', Format => 'float' },
