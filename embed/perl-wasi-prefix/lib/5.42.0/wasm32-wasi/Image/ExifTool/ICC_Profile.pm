...
%Image::ExifTool::ICC_Profile::Main = (
    ...
    B2D0 => { Name => 'BToD0', Binary => 1 },
    B2D1 => { Name => 'BToD1', Binary => 1 },
    B2D2 => { Name => 'BToD2', Binary => 1 },
    B2D3 => { Name => 'BToD3', Binary => 1 },
    D2B0 => { Name => 'DToB0', Binary => 1 },
    D2B1 => { Name => 'DToB1', Binary => 1 },
    D2B2 => { Name => 'DToB2', Binary => 1 },
    D2B3 => { Name => 'DToB3', Binary => 1 },
    rig0 => {
